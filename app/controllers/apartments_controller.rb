class ApartmentsController < ApplicationController
  ...
  def edit
    @buildings = Building.select(:id, :nombre)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @apartment.save
        format.html { redirect_to @apartment, notice: "Departamento fue creado exitosamente." }
  ...
  def update
    respond_to do |format|
      if @apartment.update(apartment_params)
        format.html { redirect_to @apartment, notice: "Departamento fue actualizado exitosamente." }
  ...
  def destroy
    @apartment.destroy
    respond_to do |format|
      format.html { redirect_to apartments_url, notice: "Departamento fue eliminado exitosamente." }
